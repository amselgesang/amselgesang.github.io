import"./gallerySkin-BCJ_IQPa.js";import{m as d,c as p,s as a,b as h,e as u,a as m,t as f}from"./thumbBackdrop-5DbnrHQE.js";const i=.15,{controls:n,chart:g,note:r}=d({title:"Breeze",intro:"Wind stirring the hanging cords — with or without a sheet. Use the wind icon on the chart to start or stop the breeze."}),l=f("breeze"),t=p(g,{categories:h,groups:a,backdrop:l,secondaryEncoding:"none",stiffness:i});u(t);const o=document.createElement("div");o.className="control-group";o.innerHTML='<label class="title" for="backdrop-select">Sheet (optional)</label>';const e=document.createElement("select");e.id="backdrop-select";e.innerHTML=`
