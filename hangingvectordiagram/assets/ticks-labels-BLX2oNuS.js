import"./gallerySkin-CcTtasEb.js";import{m as c,c as r,s as o,b as d,e as p,a as u}from"./feature-page-Bw88Xh1E.js";const{controls:t,chart:h,note:i}=c({title:"Bead ticks & labels",intro:"Scale knots along the cord (D6) and optional value captions on the labels."}),a=r(h,{categories:d,groups:o,secondaryEncoding:"none",showTicks:!0,labelValues:!0,tickTarget:8});p(a);const l=document.createElement("div");l.className="control-group";l.innerHTML=`<label class="title">Scale reference</label>
  ...
  </div>`;t.appendChild(n);n.querySelector("#tick-granularity-dial").addEventListener("input",e=>{a.setOptions({tickTarget:Number(e.target.value)})});u(t,a,o);i.hidden=!1;i.textContent="Quipu mode hides D6 bead-ticks while active — use this page to inspect ticks alone.";
